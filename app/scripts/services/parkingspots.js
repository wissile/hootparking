...
angular.module('easyparkangularApp')
    .service('ParkingSpots', function ParkingSpots($http, $q) {
      // AngularJS will instantiate a singleton by calling "new" on this function
      var deferred = $q.defer();
      var desLatLonDeferred = $q.defer();
      ...
      var parkingSpots  = {
          ...
          parkingSpots.geolocateUser().then(function(){
            ...
            directionsService.route(request, function (response, status) {
              if (status === window.google.maps.DirectionsStatus.OK) {
                ...
                desLatLonDeferred.resolve(response.routes[0].legs.end_location);
              }
            });
          });
        },
        ...
        getDestinationLatLon: function () {
          return desLatLonDeferred.promise;
        }
      };
